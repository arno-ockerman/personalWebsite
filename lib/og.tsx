    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <div style={{ fontSize: 66, fontWeight: 800, color: "#620E06", lineHeight: 1.05 }}>{title}</div>
          <div style={{ fontSize: 28, color: "rgba(0,0,0,0.7)", maxWidth: 720 }}>{subtitle}</div>
        </div>
        <div
          style={{
            fontSize: 18,
